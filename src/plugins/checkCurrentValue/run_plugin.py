"""
This script is called by the plugin-wrapper, checkCurrentValue.js, which passes down the
...
from checkCurrentValue import checkCurrentValue

logger = logging.getLogger('checkCurrentValue')
...
plugin = checkCurrentValue(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
