"""
This script is called by the plugin-wrapper, CreateGames.js, which passes down the
...
plugin = CreateGames(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
